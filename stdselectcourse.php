     ...
     <div class="sidebar">
       <div class="sidebar_menu">
         ...
         <li class="item" id="student">
          ...
          <div class="sub_menu">
            <a href="#"> <i class="fas fa-user-friends"></i><span>All Students</span></a>
            <a href="#"> <i class="fas fa-user-plus"></i><span>Add Students</span></a>
         ...
         <li class="item" id="teacher">
           ...
           <div class="sub_menu">
            <a href="#"> <i class="fas fa-chalkboard-teacher"></i><span>All Teachers</span></a>
             <a href="seletdeptforteacher.html"> <i class="fas fa-user-plus"></i><span>Add Teacher</span></a>
             <a href="#"> <i class="far fa-edit"></i><span>Edite Teacher</span></a>
        ...
        <li class="item" id="course">
          ...
          <div class="sub_menu">
            ...
            <a href="addcourse.html"> <i class="fas fa-user-plus"></i><span>Add Courses</span></a>
        ...
        <li class="item" id="departments">
          ...
          <div class="sub_menu">
            ...
            <a href="#"> <span>Add Department</span></a>
...
<form action="addstd.html">  
    
  <label>   
    Select Department
    </label> <br> 
    <select class="select_course">  
    <option value="Course" style="width: 50%; color: #4ccee8;">Select Department</option>  
    <option value="BCA"  style="color: #4ccee8;">Computer Application</option>  
    <option value="BBA" style="color: #4ccee8;">Information System</option>  
    <option value="B.Tech" style="color: #4ccee8;">Information Technology</option>  
    <option value="BCA" style="color: #4ccee8;">Software Engineering</option>   
    </select>

  <button class="submit_key" type="submit" value="submit">Proceed</button><br>
</div>
